...
* Academic, GeoQuery and Spider gold QDMRs found in the [Break dataset](https://allenai.github.io/Break)
* Gold QDMR data for IMDB and Yelp is available [in this repository](/data/qdmr_annotation)
